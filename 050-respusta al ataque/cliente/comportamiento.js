...
window.onload = function(){
    ...
    fetch(servidor+"?o=tabla&tabla=canciones")                                                 /* LLamo a un origen de datos */
    ...
    .then(function(datos){                                                  /* Y a continuación */
        ...
        if(datos.respuesta == 'ataque'){window.location = "https://google.com";}
    ...
    document.getElementById("enviar").onclick = function(){
        ...
        let mensaje = {
            ...
            "usuarios_usuario":localStorage.getItem("usuario")
        };
        fetch(servidor+"?o=insertar&tabla=canciones", {                              /* Ahora quiero obtener el count y group by de esa restriccion */
                  method: 'POST', 
                  headers: {
    ...
    document.getElementById("login").onclick = function(){
        ...
        fetch(servidor+"?o=buscar&tabla=usuarios", {                              /* Ahora quiero obtener el count y group by de esa restriccion */
                  method: 'POST', 
                  headers: {
                    'Content-Type': 'application/json', 
                  },
        ...
        .then(function(response){                                               /* Cuando obtengo respuesta */
            ...
            if(datos.length > 0){
                    localStorage.setItem("usuario",datos[0].Identificador);
                    document.getElementById("formularionuevacancion").style.display = "block";
                    document.getElementById("formulariologin").style.display = "none";
                }else{
