window.onload = function(){
    ...
    buscador.onkeyup = function(){                                          // Cuando despulso una tecla sobre el buscador
        ...
        canciones.forEach(function(cancion){                                // Y para cada una de las canciones
            if(
                cancion.titulo.toLowerCase().includes(valor.toLowerCase()) 
                || 
                cancion.artista.toLowerCase().includes(valor.toLowerCase())
                ||
                cancion.significado.toLowerCase().includes(valor.toLowerCase())
